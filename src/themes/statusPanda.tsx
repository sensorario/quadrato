...
export const STATUS_PANDA = [
    <svg width="18" height="18" style={{ verticalAlign: 'middle' }} key="panda-todo">
        ...
        <ellipse cx="5" cy="6" rx="2" ry="3" fill="#000" />
        <ellipse cx="13" cy="6" rx="2" ry="3" fill="#000" />
        <circle cx="7" cy="10" r="1.2" fill="#000" />
        <circle cx="11" cy="10" r="1.2" fill="#000" />
    ...
    <svg width="18" height="18" style={{ verticalAlign: 'middle' }} key="panda-progress">
        ...
        <circle cx="11" cy="10" r="1.2" fill="#000" />
        <ellipse cx="9" cy="13" rx="2" ry="1" fill="#000" />
        <circle cx="9" cy="9" r="3" fill="#000" opacity="0.3" />
    </svg>,
    <svg width="18" height="18" style={{ verticalAlign: 'middle' }} key="panda-done">
        ...
        <circle cx="11" cy="10" r="1.2" fill="#000" />
        <ellipse cx="9" cy="13" rx="2" ry="1" fill="#000" />
        <polyline points="6,11 9,14 13,7" fill="none" stroke="green" strokeWidth="2" />
    </svg>,
    <svg width="18" height="18" style={{ verticalAlign: 'middle' }} key="panda-skipped">
        ...
        <ellipse cx="5" cy="6" rx="2" ry="3" fill="#fff" />
        <ellipse cx="13" cy="6" rx="2" ry="3" fill="#fff" />
    </svg>
];
